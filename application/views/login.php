...
<!--                <div class="login-logo user user-menu">                    
                ...
                <div class="tab-content">
                            ...
                            <div class="row">
                                <div class="col-xs-8">
                                    <div class="checkbox icheck">
                                        <label>
                                            <a href="#tab_3" data-toggle="tab">Register</a> /
                                            <a href="#tab_2" data-toggle="tab">Forgot password</a>
                                        </label>
                                    </div>
                                </div>
                                <!-- /.col -->
                            ...
                            <div class="row">
                                <div class="col-xs-8">
                                    <div class="checkbox icheck">
                                        <div class="checkbox icheck">
                                        <label>
                                            <a href="#tab_1" data-toggle="tab">Login</a> /
                                            <a href="#tab_3" data-toggle="tab">Register</a>
                                        </label>
                                    </div>
                                    </div>
                    ...
                    <div class="tab-pane" id="tab_3">
                        <p class="login-box-msg" id="login-message">Register to start your experience</p>
                        ...
                        <form id="form-register">
                            ...
                            <div class="form-group has-feedback">
                                <input type="email" class="form-control" name="email" id="navbar-search-input" placeholder="Email"/>
                                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                            </div>
                            <div class="row">
                                <div class="col-xs-8">
